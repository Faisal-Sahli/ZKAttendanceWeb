...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.AttendanceLog", b =>
                {
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.Branch", b =>
                {
                    b.Property<int>("BranchId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.Department", b =>
                {
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.Device", b =>
                {
                    b.Property<int>("DeviceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.DeviceError", b =>
                {
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.DeviceStatus", b =>
                {
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.Employee", b =>
                {
                    b.Property<int>("EmployeeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.EmployeeBranch", b =>
                {
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.EmployeeDevice", b =>
                {
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.EmployeeShiftAssignment", b =>
                {
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.Holiday", b =>
                {
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.SyncLog", b =>
                {
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.SystemSetting", b =>
                {
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.WorkShift", b =>
                {
                    b.Property<int>("ShiftId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.AttendanceLog", b =>
                {
                    b.HasOne("ZKAttendanceWeb.Models.Branch", "Branch")
                        .WithMany("AttendanceLogs")
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ZKAttendanceWeb.Models.Device", "Device")
                        .WithMany("AttendanceLogs")
                        .HasForeignKey("DeviceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ZKAttendanceWeb.Models.Employee", "Employee")
                        .WithMany("AttendanceLogs")
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.Department", b =>
                {
                    b.HasOne("ZKAttendanceWeb.Models.Department", "ParentDepartment")
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.Employee", b =>
                {
                    b.HasOne("ZKAttendanceWeb.Models.WorkShift", "DefaultShift")
                        .WithMany("Employees")
                        .HasForeignKey("DefaultShiftId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ZKAttendanceWeb.Models.Department", "Department")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("ZKAttendanceWeb.Models.EmployeeShiftAssignment", b =>
                {
                    ...
                    b.HasOne("ZKAttendanceWeb.Models.WorkShift", "Shift")
                        .WithMany()
                        .HasForeignKey("ShiftId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ZKAttendanceWeb.Models.WorkShift", null)
